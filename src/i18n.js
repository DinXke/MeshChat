...
I18N.nl = {
  'tcp.saved': 'Bewaarde verbindingen', 'tcp.new': '(nieuwe verbinding)', 'tcp.name': 'Naam', 'tcp.namePh': 'bv. Node thuis', 'tcp.url': 'Adres van de brug', 'tcp.save': 'Bewaren', 'tcp.delete': 'Verwijderen', 'tcp.connect': 'Verbinden', 'tcp.savedToast': 'Verbinding bewaard.', 'tcp.help': 'Een browser kan niet rechtstreeks TCP. Draai op deze pc <code>python src/tools/meshchat-bridge.py &lt;ip-node&gt;</code> en gebruik ws://127.0.0.1:5005. Brug op een andere machine (bv. een Pi)? Vanaf https kan dat alleen met wss://: start de brug met <code>--tls cert.pem key.pem</code> en open eerst één keer https://&lt;brug&gt;:5005/ om het certificaat te aanvaarden.',
  'h.tcpTitle': 'Verbinden via TCP/IP (WiFi-companion, via een WebSocket-brug)', 'conn.tcpTitle': 'Verbinden via TCP/IP', 'conn.tcpLabel': 'WebSocket-adres van de brug naar de node (bv. ws://127.0.0.1:5005). Een browser kan niet rechtstreeks TCP: draai src/tools/meshchat-bridge.py <ip-node> op deze pc, of websocat.', 'conn.noWs': 'Deze browser ondersteunt geen WebSocket.', 'conn.tcpBadUrl': 'Ongeldig adres: {0}', 'conn.tcpTimeout': 'Geen antwoord van {0} binnen 10 s. Draait de brug, en staat de node aan?', 'conn.tcpFailed': 'Verbinding met {0} mislukt. Draait de brug (meshchat-bridge.py) en klopt het adres?', 'conn.tcpClosed': 'Verbinding gesloten: {0}', 'conn.tcpMixed': 'Vanaf https mag de browser alleen naar localhost een onbeveiligde ws://-verbinding openen. Draai de brug op deze pc (ws://127.0.0.1:5005), gebruik wss://, of open MeshChat als los bestand.',
  'tropo.stale': 'offline · laatst bekend: model {0} UTC',
  'tropo.legendTip': 'Tropo-ducting-schatting (Open-Meteo-weermodel, vraagt internet). Kleurschaal zoals de Hepburn-kaarten (dxinfocentre.com), berekend uit de refractiviteitsgradiënt dN/dh onder 1,5 km:\n• doorzichtig: 0, niets (gradiënt boven -60 N/km; normaal is -40)\n• paars 1 marginaal · blauw 2 redelijk · groen 3 matig · lichtgroen 4 hoog\n• geel 5 sterk · amber 6 zeer sterk · oranje 7 intens\n• rood 8 zeer intens (ducting, onder -157 N/km) · roze 9-10+ extreem\n• Schatting uit lagen van 200–700 m; dunne ducts vlak boven de grond blijven onzichtbaar.\nBron: ICON-EU (DWD) via meshmanager.net, gekalibreerd op de Hepburn-kaarten; voor 868 MHz telt de nachtelijke grondinversie boven land voor de helft mee (Hepburn negeert die).', 'tropo.opacity': 'Doorzichtigheid van de tropo-laag', 'tropo.lv.nil': 'niets', 'tropo.lv.marginal': 'marginaal', 'tropo.lv.fair': 'redelijk', 'tropo.lv.moderate': 'matig', 'tropo.lv.high': 'hoog', 'tropo.lv.strong': 'sterk', 'tropo.lv.vstrong': 'zeer sterk', 'tropo.lv.intense': 'intens', 'tropo.lv.vintense': 'zeer intens (ducting)', 'tropo.lv.extreme': 'extreem', 'tropo.rateLimited': 'te veel aanvragen bij Open-Meteo, opnieuw over {0} s',
  'emoji.flags': 'Vlaggen', 'h.nameBytes': '{0}/31 bytes (een vlag telt 8)', 'map.tools.tropo': 'Tropo', 'tropo.help': 'Tropo-ducting-schatting uit het Open-Meteo-weermodel (vraagt internet): geel = superrefractie, rood = ducting.', 'tropo.h0': 'nu', 'tropo.loading': 'laden…', 'tropo.offline': 'De tropo-overlay heeft internet nodig.', 'tropo.err': 'Tropo-gegevens ophalen mislukt: {0}', 'tropo.legend.super': 'superrefractie', 'tropo.legend.duct': 'ducting', 'tropo.data': 'model {0} UTC',
  'stat.details': 'Details', 'stat.btn': 'Statusvenster', 'stat.title': 'Status van {0}', 'stat.auto': ' Automatisch openen bij een status-antwoord', 'stat.sec.status': 'Status', 'stat.sec.radio': 'Radio-instellingen', 'stat.received': 'ontvangen {0}', 'stat.noStats': 'Nog geen status ontvangen. Klik op "Status vernieuwen".', 'stat.requested': 'Status opgevraagd…',
  'stat.batt': 'Batterij', 'stat.uptime': 'Uptime', 'stat.txq': 'TX-wachtrij', 'stat.noise': 'Ruisvloer', 'stat.rssi': 'Laatste RSSI', 'stat.snr': 'Laatste SNR', 'stat.recv': 'Ontvangen', 'stat.sent': 'Verzonden', 'stat.fd': '{0} (flood {1}, direct {2})', 'stat.airtime': 'Airtime TX / RX', 'stat.full': 'Wachtrij vol', 'stat.dups': 'Duplicaten direct / flood',
  'stat.fetch': 'Radio-instellingen ophalen', 'stat.fetching': 'Ophalen… {0}/{1}', 'stat.refresh': 'Status vernieuwen', 'stat.noRadio': 'Nog niet opgehaald. Dit stuurt een reeks get-commando\'s; sommige waarden vragen admin-login.', 'stat.off': 'uit', 'stat.r.updated': 'opgehaald {0}',
  'stat.r.radio': 'Frequentie / BW / SF / CR', 'stat.r.tx': 'Zendvermogen', 'stat.r.af': 'Airtime-factor', 'stat.r.repeat': 'Doorsturen (repeat)', 'stat.r.flood.max': 'Max. flood-hops', 'stat.r.advert.interval': 'Advert-interval (direct)', 'stat.r.flood.advert.interval': 'Advert-interval (flood)', 'stat.r.rxdelay': 'RX-vertraging', 'stat.r.txdelay': 'TX-vertraging', 'stat.r.direct.txdelay': 'TX-vertraging (direct)', 'stat.r.lat': 'Breedtegraad', 'stat.r.lon': 'Lengtegraad', 'stat.r.ver': 'Firmware', 'stat.r.clock': 'Klok',
...
I18N.en = {
  'tcp.saved': 'Saved connections', 'tcp.new': '(new connection)', 'tcp.name': 'Name', 'tcp.namePh': 'e.g. Node at home', 'tcp.url': 'Bridge address', 'tcp.save': 'Save', 'tcp.delete': 'Delete', 'tcp.connect': 'Connect', 'tcp.savedToast': 'Connection saved.', 'tcp.help': 'A browser cannot open raw TCP. Run <code>python src/tools/meshchat-bridge.py &lt;node-ip&gt;</code> on this PC and use ws://127.0.0.1:5005. Bridge on another machine (e.g. a Pi)? From https that only works with wss://: start the bridge with <code>--tls cert.pem key.pem</code> and open https://&lt;bridge&gt;:5005/ once to accept the certificate.',
  'h.tcpTitle': 'Connect via TCP/IP (WiFi companion, through a WebSocket bridge)', 'conn.tcpTitle': 'Connect via TCP/IP', 'conn.tcpLabel': 'WebSocket address of the bridge to the node (e.g. ws://127.0.0.1:5005). A browser cannot open raw TCP: run src/tools/meshchat-bridge.py <node-ip> on this PC, or websocat.', 'conn.noWs': 'This browser does not support WebSocket.', 'conn.tcpBadUrl': 'Invalid address: {0}', 'conn.tcpTimeout': 'No answer from {0} within 10 s. Is the bridge running and the node on?', 'conn.tcpFailed': 'Connection to {0} failed. Is the bridge (meshchat-bridge.py) running and the address right?', 'conn.tcpClosed': 'Connection closed: {0}', 'conn.tcpMixed': 'From https the browser only allows an insecure ws:// connection to localhost. Run the bridge on this PC (ws://127.0.0.1:5005), use wss://, or open MeshChat as a local file.',
  'tropo.stale': 'offline · last known: model {0} UTC',
  'tropo.legendTip': 'Tropospheric ducting estimate (Open-Meteo weather model, needs internet). Colour scale like the Hepburn maps (dxinfocentre.com), derived from the refractivity gradient dN/dh below 1.5 km:\n• transparent: 0, nil (gradient above -60 N/km; -40 is normal)\n• purple 1 marginal · blue 2 fair · green 3 moderate · lime 4 high\n• yellow 5 strong · amber 6 very strong · orange 7 intense\n• red 8 very intense (ducting, below -157 N/km) · pink 9-10+ extreme\n• Estimated from layers of 200–700 m; thin ducts close to the ground stay invisible.\nSource: ICON-EU (DWD) via meshmanager.net, calibrated against the Hepburn maps; for 868 MHz the nocturnal ground inversion over land counts at half weight (Hepburn ignores it).', 'tropo.opacity': 'Opacity of the tropo layer', 'tropo.lv.nil': 'nil', 'tropo.lv.marginal': 'marginal', 'tropo.lv.fair': 'fair', 'tropo.lv.moderate': 'moderate', 'tropo.lv.high': 'high', 'tropo.lv.strong': 'strong', 'tropo.lv.vstrong': 'very strong', 'tropo.lv.intense': 'intense', 'tropo.lv.vintense': 'very intense (ducting)', 'tropo.lv.extreme': 'extreme', 'tropo.rateLimited': 'too many requests to Open-Meteo, retrying in {0} s',
  'emoji.flags': 'Flags', 'h.nameBytes': '{0}/31 bytes (a flag counts 8)', 'map.tools.tropo': 'Tropo', 'tropo.help': 'Tropospheric ducting estimate from the Open-Meteo weather model (needs internet): yellow = super-refraction, red = ducting.', 'tropo.h0': 'now', 'tropo.loading': 'loading…', 'tropo.offline': 'The tropo overlay needs an internet connection.', 'tropo.err': 'Fetching tropo data failed: {0}', 'tropo.legend.super': 'super-refraction', 'tropo.legend.duct': 'ducting', 'tropo.data': 'model {0} UTC',
  'stat.details': 'Details', 'stat.btn': 'Status window', 'stat.title': 'Status of {0}', 'stat.auto': ' Open automatically on a status reply', 'stat.sec.status': 'Status', 'stat.sec.radio': 'Radio settings', 'stat.received': 'received {0}', 'stat.noStats': 'No status received yet. Click "Refresh status".', 'stat.requested': 'Status requested…',
  'stat.batt': 'Battery', 'stat.uptime': 'Uptime', 'stat.txq': 'TX queue', 'stat.noise': 'Noise floor', 'stat.rssi': 'Last RSSI', 'stat.snr': 'Last SNR', 'stat.recv': 'Received', 'stat.sent': 'Sent', 'stat.fd': '{0} (flood {1}, direct {2})', 'stat.airtime': 'Airtime TX / RX', 'stat.full': 'Queue full', 'stat.dups': 'Duplicates direct / flood',
  'stat.fetch': 'Fetch radio settings', 'stat.fetching': 'Fetching… {0}/{1}', 'stat.refresh': 'Refresh status', 'stat.noRadio': 'Not fetched yet. This sends a series of get commands; some values require admin login.', 'stat.off': 'off', 'stat.r.updated': 'fetched {0}',
  'stat.r.radio': 'Frequency / BW / SF / CR', 'stat.r.tx': 'TX power', 'stat.r.af': 'Airtime factor', 'stat.r.repeat': 'Forwarding (repeat)', 'stat.r.flood.max': 'Max. flood hops', 'stat.r.advert.interval': 'Advert interval (direct)', 'stat.r.flood.advert.interval': 'Advert interval (flood)', 'stat.r.rxdelay': 'RX delay', 'stat.r.txdelay': 'TX delay', 'stat.r.direct.txdelay': 'TX delay (direct)', 'stat.r.lat': 'Latitude', 'stat.r.lon': 'Longitude', 'stat.r.ver': 'Firmware', 'stat.r.clock': 'Clock',
...
I18N.fr = {
  'tcp.saved': 'Connexions enregistrées', 'tcp.new': '(nouvelle connexion)', 'tcp.name': 'Nom', 'tcp.namePh': 'ex. Nœud maison', 'tcp.url': 'Adresse du pont', 'tcp.save': 'Enregistrer', 'tcp.delete': 'Supprimer', 'tcp.connect': 'Connecter', 'tcp.savedToast': 'Connexion enregistrée.', 'tcp.help': 'Un navigateur ne peut pas ouvrir de TCP brut. Lancez <code>python src/tools/meshchat-bridge.py &lt;ip-du-nœud&gt;</code> sur ce PC et utilisez ws://127.0.0.1:5005. Pont sur une autre machine (ex. un Pi) ? Depuis https, seul wss:// fonctionne : lancez le pont avec <code>--tls cert.pem key.pem</code> et ouvrez une fois https://&lt;pont&gt;:5005/ pour accepter le certificat.',
  'h.tcpTitle': 'Connecter via TCP/IP (companion WiFi, via un pont WebSocket)', 'conn.tcpTitle': 'Connexion TCP/IP', 'conn.tcpLabel': 'Adresse WebSocket du pont vers le nœud (ex. ws://127.0.0.1:5005). Un navigateur ne peut pas ouvrir de TCP brut : lancez src/tools/meshchat-bridge.py <ip-du-nœud> sur ce PC, ou websocat.', 'conn.noWs': 'Ce navigateur ne prend pas en charge WebSocket.', 'conn.tcpBadUrl': 'Adresse invalide : {0}', 'conn.tcpTimeout': 'Pas de réponse de {0} en 10 s. Le pont tourne-t-il et le nœud est-il allumé ?', 'conn.tcpFailed': 'Connexion à {0} échouée. Le pont (meshchat-bridge.py) tourne-t-il et l\'adresse est-elle correcte ?', 'conn.tcpClosed': 'Connexion fermée : {0}', 'conn.tcpMixed': 'Depuis https, le navigateur n\'autorise une connexion ws:// non sécurisée que vers localhost. Lancez le pont sur ce PC (ws://127.0.0.1:5005), utilisez wss://, ou ouvrez MeshChat comme fichier local.',
  'tropo.stale': 'hors ligne · dernier connu : modèle {0} UTC',
  'tropo.legendTip': 'Estimation de la propagation troposphérique (modèle météo Open-Meteo, nécessite internet). Échelle de couleurs comme les cartes Hepburn (dxinfocentre.com), calculée à partir du gradient de réfractivité dN/dh sous 1,5 km :\n• transparent : 0, rien (gradient au-dessus de -60 N/km ; -40 est normal)\n• violet 1 marginal · bleu 2 passable · vert 3 modéré · vert clair 4 élevé\n• jaune 5 fort · ambre 6 très fort · orange 7 intense\n• rouge 8 très intense (ducting, sous -157 N/km) · rose 9-10+ extrême\n• Estimation à partir de couches de 200–700 m ; les conduits minces près du sol restent invisibles.\nSource : ICON-EU (DWD) via meshmanager.net, calibré sur les cartes Hepburn ; pour 868 MHz l\'inversion nocturne au sol compte pour moitié (Hepburn l\'ignore).', 'tropo.opacity': 'Opacité de la couche tropo', 'tropo.lv.nil': 'rien', 'tropo.lv.marginal': 'marginal', 'tropo.lv.fair': 'passable', 'tropo.lv.moderate': 'modéré', 'tropo.lv.high': 'élevé', 'tropo.lv.strong': 'fort', 'tropo.lv.vstrong': 'très fort', 'tropo.lv.intense': 'intense', 'tropo.lv.vintense': 'très intense (ducting)', 'tropo.lv.extreme': 'extrême', 'tropo.rateLimited': 'trop de requêtes vers Open-Meteo, nouvel essai dans {0} s',
  'emoji.flags': 'Drapeaux', 'h.nameBytes': '{0}/31 octets (un drapeau compte 8)', 'map.tools.tropo': 'Tropo', 'tropo.help': 'Estimation de la propagation troposphérique (ducting) d\'après le modèle météo Open-Meteo (nécessite internet) : jaune = superréfraction, rouge = ducting.', 'tropo.h0': 'maintenant', 'tropo.loading': 'chargement…', 'tropo.offline': 'La couche tropo nécessite une connexion internet.', 'tropo.err': 'Échec du chargement des données tropo : {0}', 'tropo.legend.super': 'superréfraction', 'tropo.legend.duct': 'ducting', 'tropo.data': 'modèle {0} UTC',
  'stat.details': 'Détails', 'stat.btn': 'Fenêtre d\'état', 'stat.title': 'État de {0}', 'stat.auto': ' Ouvrir automatiquement à chaque réponse status', 'stat.sec.status': 'État', 'stat.sec.radio': 'Paramètres radio', 'stat.received': 'reçu {0}', 'stat.noStats': 'Aucun état reçu pour l\'instant. Cliquez sur « Actualiser l\'état ».', 'stat.requested': 'État demandé…',
  'stat.batt': 'Batterie', 'stat.uptime': 'Uptime', 'stat.txq': 'File TX', 'stat.noise': 'Bruit de fond', 'stat.rssi': 'Dernier RSSI', 'stat.snr': 'Dernier SNR', 'stat.recv': 'Reçus', 'stat.sent': 'Envoyés', 'stat.fd': '{0} (flood {1}, direct {2})', 'stat.airtime': 'Airtime TX / RX', 'stat.full': 'File pleine', 'stat.dups': 'Doublons direct / flood',
  'stat.fetch': 'Récupérer les paramètres radio', 'stat.fetching': 'Récupération… {0}/{1}', 'stat.refresh': 'Actualiser l\'état', 'stat.noRadio': 'Pas encore récupéré. Une série de commandes get est envoyée ; certaines valeurs nécessitent une connexion admin.', 'stat.off': 'désactivé', 'stat.r.updated': 'récupéré {0}',
  'stat.r.radio': 'Fréquence / BW / SF / CR', 'stat.r.tx': 'Puissance d\'émission', 'stat.r.af': 'Facteur d\'airtime', 'stat.r.repeat': 'Relais (repeat)', 'stat.r.flood.max': 'Sauts flood max.', 'stat.r.advert.interval': 'Intervalle d\'annonce (direct)', 'stat.r.flood.advert.interval': 'Intervalle d\'annonce (flood)', 'stat.r.rxdelay': 'Délai RX', 'stat.r.txdelay': 'Délai TX', 'stat.r.direct.txdelay': 'Délai TX (direct)', 'stat.r.lat': 'Latitude', 'stat.r.lon': 'Longitude', 'stat.r.ver': 'Firmware', 'stat.r.clock': 'Horloge',
