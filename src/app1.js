...
const APP_VERSION = '0.3.2', APP_REPO = 'https://github.com/DinXke/MeshChat', APP_AUTHOR = 'DinX';
...
const S = {
  ...
  roomPw: {},                  // pub -> {pw, auto}
  settings: { theme: 'auto', ts: true, compact: false, meta: true, notif: true, debug: false, showSensorsAsRepeaters: true, staleDays: 7, favOnly: true, regions: [], tropo: false, tropoH: 0, tropoOp: 75, statusPopup: 'manual' },
