...
const APP_VERSION = '0.1.0', APP_REPO = 'https://github.com/DinXke/MeshChat', APP_AUTHOR = 'DinX';
...
const S = {
  ...
  roomPw: {},                  // pub -> {pw, auto}
  settings: { theme: 'auto', ts: true, compact: false, meta: true, notif: true, debug: false, showSensorsAsRepeaters: true, staleDays: 7, favOnly: true },
